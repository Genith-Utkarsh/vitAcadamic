...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full bg-[#cfeee9]">
                <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">

                    <div className="max-w-96">
                        <img className="h-15" src="/VIT2.png" />
                    ...
                    <div className="w-1/2 flex flex-wrap md:flex-nowrap justify-between">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-500 space-y-2 list-none">
                                ...
                                <button className='bg-[#33A491] p-2 text-white rounded-sm' onClick={()=>setfeedbackon(true)}>
                                    Send FeedBack
                                </button>
                            </div>
                        </div>
                ...
                <p className="py-4 text-center text-xs md:text-sm text-gray-500">
                    Copyright 2025 © kiran.dev & Team. All Right Reserved.
                </p>
            </footer>
